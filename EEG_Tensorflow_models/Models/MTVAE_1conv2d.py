...
def MTVAE_1conv2d(nb_classes, Chans = 22, Samples = 250, dropoutRate = 0.5, l1 = 0, l2 = 0):
    ...
    block2       = Conv2DTranspose(40, pool,strides=strid,activation='linear', kernel_regularizer=l1_l2(l1=l1,l2=l2),
                          kernel_constraint = max_norm(2., axis=(0,1,2)))(codings)

    block2       = Resizing(block2.shape[1], Act1.shape[2])(block2)
    block2       = Conv2DTranspose(1, (Chans, kernel_time),strides=(1,2), use_bias=bias_spatial, kernel_regularizer=l1_l2(l1=l1,l2=l2),
